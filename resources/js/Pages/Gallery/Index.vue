                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="(item, index) in galleries" :key="item.id"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <Link class="cursor-pointer" :href="route('dashboard.jewelry.edit', item.id)" tag="button">
                                                <ArrowPathIcon
                                                    class=" h-5 w-5 text-brand-primary-600 hover:text-brand-primary-900" />
                                                </Link>
                                            </td>

                                            <td class="cursor-pointer px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
